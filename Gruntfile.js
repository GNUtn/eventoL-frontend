...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        ngconstant: {
            options: {
                name      : 'eventoLFrontendApp.constants',
        ...
        sass: {
            server: {
                options: {
                    loadPath: '<%= yeoman.client %>/bower_components/bootstrap-sass/assets/stylesheets',
                    compass : false
                },
                files  : {
                ...
                files  : {
                    '<%= yeoman.client %>/index.html': [
                        [
                            ...
                            '!{.tmp,<%= yeoman.client %>}/app/app-dev.js'
                        ]
                    ]
                }
            },
    ...
    grunt.registerTask('serve', function(target) {
        if(target === 'dist') {
            return grunt.task.run(
                ['processhtml', 'build', 'env:all', 'env:prod', 'express:prod', 'wait', 'open', 'express-keepalive']);
        }
